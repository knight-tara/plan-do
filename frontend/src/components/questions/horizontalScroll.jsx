        ...
        <div className="horizontalQuestionContainer ">
          <motion.div className="horizontalQuestions" style={{ x }}>
            ...
            <div ref={questionRefs[1]}>
              <Question3
                scrollToNext={() => scrollToQuestion(2)}
                scrollToPrevious={() => scrollToQuestion(0)}
              />
            </div>
            <div ref={questionRefs[2]}>
              <Question4
                scrollToNext={() => scrollToQuestion(3)}
                scrollToPrevious={() => scrollToQuestion(1)}
              />
            </div>
            <div ref={questionRefs[3]}>
              <Question5
                scrollToNext={() => scrollToQuestion(4)}
                scrollToPrevious={() => scrollToQuestion(2)}
              />
            </div>
            <div ref={questionRefs[4]}>
              <Question6
                scrollToNext={scrollToInspiration}
                scrollToPrevious={() => scrollToQuestion(3)}
